        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="max-w-xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6">
              Welcome to Afringe DPA Software
              <br />
              the Ultimate Dashboard.
            </h1>
            <p className="text-gray-600 mb-8">
              Experience the power of our software with a seamless and intuitive interface. Our dashboard is designed to provide you with all the tools you need to manage your data effectively and efficiently.
            </p>
